...
**Status:** slice 2 built (2026-09-04). Slices 1, 3, 4 not started.
...
| 3. Draw the fence, typed measured lengths | ✓ already works |
| 4. Per stretch: how tall, what it sits on, which model | ✓ modelled — words fixed in slice 2 |
| 5. Gates — where, how wide | ✓ already works |
